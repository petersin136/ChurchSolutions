    ...
    <div className="relative">
      ...
      <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr 1fr" : "repeat(4, 1fr)", gap: mob ? 8 : 16 }}>
        ...
        >
          ...
          <div style={{ fontSize: mob ? 20 : 26, fontWeight: mob ? 800 : 700, color: "#1B2A4A", lineHeight: 1.2 }}>{donorList.length}명</div>
        </div>
        <div
          style={{
            background: "#fff",
        ...
        >
          ...
          <div style={{ fontSize: mob ? 16 : 22, fontWeight: mob ? 800 : 700, color: "#1B2A4A", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>₩{fmt(avgPerDonor)}</div>
        </div>
        <div
          style={{
            background: "#fff",
        ...
        >
          ...
          <div style={{ fontSize: mob ? 16 : 22, fontWeight: mob ? 800 : 700, color: "#1B2A4A" }}>{newDonorsThisYear}명</div>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 lg:p-6">
          <h4 className="font-semibold text-[#1B2A4A] mb-4 text-sm lg:text-base">월별 헌금자 수</h4>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 lg:p-6">
          <h4 className="font-semibold text-[#1B2A4A] mb-4 text-sm lg:text-base">헌금 구간별 분포</h4>
          <LazyChart height={mob ? 200 : 300}>
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="px-4 py-3 lg:px-5 border-b border-gray-100 flex items-center justify-between gap-4">
          <h4 className="font-semibold text-[#1B2A4A] text-sm lg:text-base">헌금자 목록</h4>
