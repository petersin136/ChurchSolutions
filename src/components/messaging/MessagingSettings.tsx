...
export function MessagingSettings({
  ...
  return (
    <div style={{ width: "100%", background: C.card, borderRadius: 7, border: `1px solid ${C.border}`, padding: 24, boxShadow: "0 1px 3px rgba(0,0,0,0.04)", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div>
        ...
        <input
          ...
          style={{ width: "100%", borderRadius: 7, border: `1px solid ${C.border}`, padding: "10px 12px", fontSize: 14 }}
        />
      </div>
      <div>
      ...
      <button type="button" onClick={handleSave} style={{ padding: "10px 16px", borderRadius: 7, background: C.navy, color: "white", fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer", alignSelf: "flex-start" }}>
        저장
      </button>
    </div>
  );
